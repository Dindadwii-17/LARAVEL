...
<body>
    <div class="page">
        ...
        <div class="header-section">
            <h2><i class="fas fa-book"></i> Koleksi Buku Fisik</h2>
            <a href="{{ route('admin.books.create') }}" class="btn-add"><i class="fas fa-plus-circle"></i> Tambah Buku</a>
        </div>
            ...
            <table>
                ...
                <tbody>
                    @forelse ($books as $book)
                        ...
                        <tr>
                            <td>#{{ $book->id }}</td>
                            <td style="font-weight: 700; color: #000000;">{{ $book->title }}</td>
                            <td>{{ $book->author }}</td>
                            <td><span class="badge badge-stock">{{ $book->stock }} Buku</span></td>
                            <td>{{ $book->category->name ?? 'Umum' }}</td>
                            <td>
                                <a href="{{ route('admin.books.edit', $book->id) }}" class="btn-action btn-edit"><i class="fas fa-edit"></i> Edit</a>
                                <form action="{{ route('admin.books.delete', $book->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('Hapus buku ini?')">
                                    @csrf @method('DELETE')
                        ...
                        @endif
                    @empty
                        <tr><td colspan="6" style="text-align: center; padding: 40px; color: #64748b;">Belum ada koleksi buku.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
